--=Load data for the silver layer
--1. truncating the existing silver layer table
--2. ingesting the table with manipulated data from bronze layer
	...
	BEGIN TRY
		...
		INSERT INTO [silver].[erp_loc_a101](cid,cntry)
			...
			,CASE WHEN TRIM(cntry) = 'DE' THEN 'Germany'
				  ...
				  WHEN TRIM(cntry) = '' or TRIM(cntry) IS NULL THEN '_NA'
				  ELSE TRIM(cntry)
			  END cntry
